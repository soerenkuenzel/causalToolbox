  ...
  function(feat,
    ...
    m_0 <-
      honestRF(
        ...
        sampsize = round(tuned_setting_control$sample_fraction_first * length(yobs_0)),
    ...
    m_1 <-
      honestRF(
        ...
        sampsize = round(tuned_setting_treated$sample_fraction_first * length(yobs_0)),
