...
Rand_tune <- data.frame(
  ...
  sampsize_first  = sample(seq(from = 0.1, to = 1, by = 0.1), nsamples,replace = TRUE),
  sampsize_second = sample(seq(from = 0.1, to = 1, by = 0.1), nsamples,replace = TRUE),
  sampsize_prop   = sample(seq(from = 0.1, to = 1, by = 0.1), nsamples,replace = TRUE),
  ...
  nodesizeSpl_first  = sample(c(1, 3, 5, 10, 30, 100), nsamples, replace = TRUE),
  nodesizeSpl_second = sample(c(1, 3, 5, 10, 30, 100), nsamples, replace = TRUE),
  nodesizeSpl_prop   = sample(c(1, 3, 5, 10, 30, 100), nsamples, replace = TRUE),
  nodesizeAvg_first  = sample(c(1, 3, 5, 10, 30, 100), nsamples, replace = TRUE),
  nodesizeAvg_second = sample(c(1, 3, 5, 10, 30, 100), nsamples, replace = TRUE),
  nodesizeAvg_prop   = sample(c(1, 3, 5, 10, 30, 100), nsamples, replace = TRUE),
