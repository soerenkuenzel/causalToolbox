...
Rand_tune <- data.frame(
  ...
  nodesizeSpl_first  = sample(1:30, size = nsamples, replace = TRUE),
  nodesizeSpl_second = sample(1:30, size = nsamples, replace = TRUE),
  nodesizeSpl_prop   = sample(1:30, size = nsamples, replace = TRUE),
  nodesizeAvg_first  = sample(1:30, size = nsamples, replace = TRUE),
  nodesizeAvg_second = sample(1:30, size = nsamples, replace = TRUE),
  nodesizeAvg_prop   = sample(1:30, size = nsamples, replace = TRUE),
